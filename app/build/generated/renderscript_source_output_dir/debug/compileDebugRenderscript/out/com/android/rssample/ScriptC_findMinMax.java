 ...
 * The source Renderscript file: /autofs/unitytravail/travail/khouchat/Licence 3/Projet tec android/groupe/projettec/app/src/main/rs/findMinMax.rs
 */

package com.android.rssample;

import androidx.renderscript.*;
import com.android.rssample.findMinMaxBitCode;
...
public class ScriptC_findMinMax extends ScriptC {
    ...
    // Constructor
    public  ScriptC_findMinMax(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              findMinMaxBitCode.getBitCode32(),
              findMinMaxBitCode.getBitCode64());
        mRSLocal = rs;
    ...
    private final static int mExportReduceIdx_findMinAndMax = 0;
    // in1 = "in", flattened 4-vectors
    public result_int2 reduce_findMinAndMax(byte[] in1) {
