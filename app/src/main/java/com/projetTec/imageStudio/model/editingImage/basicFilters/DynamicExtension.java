...
/**
 * <p>
 * This class contains the methods necessary for the application of a dynamic extension on bitmaps.
 * </p>
 *
 * @author Kamel.H
...
public class DynamicExtension {
    ...
    public void contrastPlusCouleurRGB(Bitmap imageBitmap) {
        ...
        int minR = min_max_R[0];
        int maxR = min_max_R[1];
        int[] min_max_G = AuxiliaryFunction.minMax(histoG);
        int minG = min_max_G[0];
        int maxG = min_max_G[1];
        int[] min_max_B = AuxiliaryFunction.minMax(histoB);
        int minB = min_max_B[0];
        int maxB = min_max_B[0];
